...
// Bridges regular HTML <img> elements to LunaSVG and Dear ImGui's renderer-
// managed texture API. Registered image bytes are borrowed from the caller;
// applications normally provide embedded assets with static storage.
class UiImageCache {
public:
    UiImageCache();
    ~UiImageCache();
